...
Native Flutter frontend for the subscription-backed Sloppa-Backend bridge. ChatGPT cookies/browser tokens remain server-side, bridge credentials use OS secure storage, and cached conversations are AES-256-GCM encrypted.
