...
class Service:
    ...
    async def start(self) -> None:
        ...
        # Off by default; only writes artifacts when SLOPPA_DIAGNOSE=1.
    ...
    def _check_bind_safety(cfg: Config) -> None:
        ...
        The env override is ``SLOPPA_ALLOW_UNAUTH_REMOTE=1``. The error message
        ...
        allow_unauth_remote = os.environ.get("SLOPPA_ALLOW_UNAUTH_REMOTE", "").strip() == "1"
        ...
        if loopback and not has_keys:
            ...
            raise RuntimeError(
                ...
                f"config, bind to 127.0.0.1, or set SLOPPA_ALLOW_UNAUTH_REMOTE=1 "
            ...
            logger.warning(
                ...
                "SLOPPA_ALLOW_UNAUTH_REMOTE=1. Anyone who can reach this host "
